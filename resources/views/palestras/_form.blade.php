...
<div class="mb-3">
    ...
    @error('palestrante') <div class="form-error">{{ $message }}</div> @enderror
</div>
<div class="mb-3">
    <label class="form-label">Data (YYYY-MM-DD HH:MM)</label><br>
    <input class="form-control" type="datetime-local" name="data" placeholder="2025-10-22 19:30" value="{{ old('data', isset($palestra)?$palestra->data?->format('Y-m-d H:i'):'') }}">
